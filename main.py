...
class MyGame(arcade.Window):
    ...
    def on_draw(self):
        arcade.start_render()
        arcade.draw_text("Roock paper, cissor",
                         0, 500, arcade.csscolor.DARK_MAGENTA, 50, width=SCREEN_WIDTH, align="center")
        arcade.draw_text(f"Les points du joueur est {self.player_score} ",
                         100, 100, arcade.csscolor.HONEYDEW, 10, width=SCREEN_WIDTH, align="left")
        arcade.draw_text(f"Les points de l'ordinateur est {self.computer_score}",
                         500, 100, arcade.csscolor.HONEYDEW, 10, width=SCREEN_WIDTH, align="left")
        self.player.draw()
        self.computer.draw()
        if self.game_state == GameState.NOT_STARTED:
            arcade.draw_text("Appuyer sur une des attaques !",
            ...
            if self.player_wins_round:
                arcade.draw_text("chanceux vouz avez gagner!",
                                 0, 350, arcade.csscolor.HONEYDEW, 20, width=SCREEN_WIDTH, align="center")
            else:
                if self.ronde_nulle:
                    arcade.draw_text("nul",
                                     0, 350, arcade.csscolor.HONEYDEW, 20, width=SCREEN_WIDTH, align="center")
                else:
                    arcade.draw_text("jai gagner!",
                                     0, 350, arcade.csscolor.HONEYDEW, 20, width=SCREEN_WIDTH, align="center")
            arcade.draw_rectangle_outline(125, 150, 50, 50, arcade.color.SIENNA)
